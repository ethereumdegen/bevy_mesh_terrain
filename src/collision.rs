...
/*
It is the end users responsibility to detect for these components and also add  their own collider component 
...
pub struct CollisionData {
     ...
     heightmap_data: SubHeightMapU16
     //add heightfield 
